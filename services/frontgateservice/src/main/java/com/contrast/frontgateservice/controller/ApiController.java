...
public class ApiController {
    ...
    private ObjectInputFilter createAddressImportFilter() {
        // Use pattern-based filter to allow only safe Java standard library classes
        // This prevents deserialization of arbitrary classes (gadget chains)
        // Pattern: allow java.util.*, java.lang.*, and their arrays; reject everything else
