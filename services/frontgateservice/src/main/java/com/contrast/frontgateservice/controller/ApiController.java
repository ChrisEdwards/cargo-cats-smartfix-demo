...
public class ApiController {
    ...
    private static ObjectInputFilter createAddressImportFilter() {
        return filterInfo -> {
            ...
            // Allow safe java.lang and java.util classes (including internal types)
            // Block all other packages to prevent deserialization attacks
            if (className.startsWith("java.lang.") ||
                className.startsWith("java.util.") ||
                className.startsWith("[Ljava.lang.") ||
                className.startsWith("[Ljava.util.") ||
